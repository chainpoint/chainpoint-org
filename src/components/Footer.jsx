    ...
    <footer>
      <div className='container'>
        <div className='inner'>
          ...
          <div className='d-none d-sm-block'>
            <p className='right'><span className='social'><a href='https://www.facebook.com/chainpoint' target='_blank' className='facebook' /><a href='https://twitter.com/chainpnt' target='_blank' className='twitter' /></span></p>
          </div>
