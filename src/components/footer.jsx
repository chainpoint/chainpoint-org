    ...
    <footer>
      <div className='container'>
        <div className='inner'>
          ...
          <p className='small-date visible-xs'>&copy; 2017</p>
          <a id='flogo' href='#' className='go-top' /><a href='https://tierion.com' target='_blank' className='site-by hidden-xs'>site by Tierion</a>
        </div>
      </div>
    </footer>
  )
